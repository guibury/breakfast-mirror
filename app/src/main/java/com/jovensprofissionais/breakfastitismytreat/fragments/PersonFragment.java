...
import com.jovensprofissionais.breakfastitismytreat.MainActivity;
...
public class PersonFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rankingDBController = new RankingDBController(getActivity());
        voteButton = (Button) getView().findViewById(R.id.voteButton);
        personOfTheWeek = (TextView) getView().findViewById(R.id.personOfTheWeek);
    ...
    View.OnClickListener voteHandler = new View.OnClickListener() {
        @Override
